...
<br>
[![Yapımcı](https://img.shields.io/badge/Anket-Link-red?style=flat-square)](https://forms.gle/9K2szawmp8pE7mHk7)

---
# 🏗️ YAPIM AŞAMASINDA (WIP)

> **Dikkat:** Bu proje henüz geliştirme aşamasındadır. Bazı özellikler eksik olabilir veya hatalar içerebilir. Projenin tam sürüme geçiş çalışmaları devam etmektedir.
...
│
├── 📂 css/
│   └── 🎨 style.css                # AEÜ temalı stiller
├── 📂 img/
│   └── 🖼️ logo.png                 # Üniversite logosu veya görseller
├── 📂 js/
│   └── ⚙️ app.js                   # Uygulama/Form mantığı
...
```bash
# Repoyu klonla
git clone https://github.com/gb0u/AEU_anonim_hikaye_paylasim_forumu.git

# Klasöre gir
cd AEU_anonim_hikaye_paylasim_forumu
...
<div align="center">
  <sub>© 2026 Hamza Kahveci — Kırşehir Ahi Evran Üniversitesi TBMYO Bilgisayar Programcılığı</sub><br/>
